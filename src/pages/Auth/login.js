    ...
    <div>
      <section className="bg-gray-50 dark:bg-gray-900 h-screen">
        <div className="grid  max-w-screen    lg:grid-cols-12">
          ...
          <div className="w-full mt-[80px] p-6 mx-auto bg-white rounded-lg shadow dark:bg-gray-800 sm:max-w-xl lg:col-span-6 sm:p-8">
            <h1 className="mb-[40px] text-2xl text-center font-bold leading-tight tracking-tight text-gray-900 dark:text-white">
              Login
            </h1>
            <div className="space-y-3">
              <button
                ...
                className="w-full inline-flex items-center justify-center py-2.5 px-5 mr-2 mb-[20px] text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-gray-900 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700"
              >
                <svg
            ...
            <form onSubmit={Loginuser} className="mt-4 space-y-6 sm:mt-6">
              <div className=" w-full ">
                ...
                <div className="text-inter text-darkGray">
